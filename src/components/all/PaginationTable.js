...
export function PaginationTable(props){
    ...
    return (
        <div className='pg_back'>
            ...
            <div style={{padding: 5}}/>
                <p className='page_showing'>/{pageCount}</p>
            <div className='pg_select_back'> 
                <Select className='pg_select'
                    value={pageSize}
...
export function PaginationList(props){
    ...
    return (
        <div className='pg_back'>
            ...
            <button className='pg_btn' disabled={page >= count}
                onClick={() => onClick(page + 1)}>
            <FiChevronRight className='pg_icon' />
            </button>
            <div className='pg_select_back'>
                <Select className='pg_select'
                    ...
                    onSelect={e => onSizeChange(Number(e))}>{pageRange?.map(item => {
