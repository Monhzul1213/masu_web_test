...
export function Search(props){
  const { handleEnter, size, data, setData, siteId, setSiteId, status, newItem, setTotal, columns} = props;
  ...
  const importModalProps = { visible: open, closeModal: closeModal1, setVisible: setOpen, data, setData, newItem, setTotal, columns};
