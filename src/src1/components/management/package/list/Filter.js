...
import { ButtonRowAddConfirm, PlainRange, PlainSelect } from '../../../../components/all/all_m';
...
export function Filter(props){
  ...
  const onFocusStatus = async () => {
    if(!states?.length || states?.length === 1){
      setStates([
        ...
        { valueNum: 1, valueStr1: 'Багцлалт хийсэн' },
      ]);
    }
  }
  ...
  const addProps = { type: 'package', onClickAdd, show: false };
