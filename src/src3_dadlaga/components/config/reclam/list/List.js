...
import { Table, Check, PaginationTable } from '../../../../../components/all';
...
export function List(props) {
  ...
  useEffect(() => {
    ...
    setColumns([
      ...
      { Header: t('reclam.name'), accessor: 'adsName' },
  ...
  const onRowClick = row => {
    navigate({ pathname: 'reclam_add', search: createSearchParams({ adsId: row?.original?.adsId}).toString() });
  }
