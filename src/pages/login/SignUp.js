...
export function SignUp(){
  ...
  const emailProps = { text: t('login.email'), value: email, setValue: setEmail, setError, Icon: () => <DynamicAIIcon className='lg_input_icon' name='AiOutlineUser'/> };
  const passProps = { text: t('login.password'), value: password, setValue: setPassword, setError };
  ...
  return (
    <div className='login_container1'>
      ...
      <form onSubmit={handleSubmit} autoComplete='off' style={{width: 400}}>
        ...
        <FloatingInput1 {...businessProps} className='lg_input_back' color='#fff' />
        <RadioSelect {...subProps}/>  
        <FloatingInput1 {...addressProps} className='lg_input_back' color='#fff' />
        <Partner {...partProps} className='lg_partner_field' />
        <div className='co_gap' />
        <div className='co_gap' />
        <div className='l_check_row'>
          <Checkbox {...checkProps} />
