...
import { Info, Advert, AdvertAdd, NotiAdd, Notification, PartnerInfo, Rating, RatingAdd } from './src1/pages/system';
          ...
          <Layout>
            ...
            <Layout>
              <Routes>
                ...
                <Route path='/system/rating' element={<Rating />} />
                <Route path='/system/rating/rating_add' element={<RatingAdd />} />
              </Routes>
            </Layout>
          </Layout>
          }</SizeMe>
