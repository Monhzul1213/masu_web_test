...
import { ButtonRowAddConfirm, DynamicAIIcon, PlainRange, PlainSelect } from '../../../../../src1/components/all/all_m';
...
export function Filter(props){
  ...
  const onHide = (status, name) => {
    let query = '?BeginDate=' + date[0]?.format('yyyy.MM.DD') + '&EndDate=' + date[1]?.format('yyyy.MM.DD') + '&Descr=' + name;
  ...
  const addProps = { type: 'voucher', onClickAdd, show: false };
