...
export function ButtonRow(props) {
  ...
  return (
    <div className="a_btn_row">
      ...
      <Button
        className="a_btn"
        text={t(text1 ?? "page.cancel")}
        onClick={onClickCancel}
      />
      <Button
        className="a_btn"
        id="a_btn_save"
        text={t(text2 ?? "page.save")}
        type={type}
        onClick={onClickSave}
      />
    </div>
    ...
    <div className="add_row_back">
      ...
      {show && (
        <IconButton
          ...
          id="add_row_delete"
          icon={
            <DynamicBSIcon name="BsTrash" className="add_row_delete_icon" />
          }
          onClick={onClickDelete}
        />
      )}
...
export function ButtonRowConfirm(props) {
  ...
  return (
    <div className={isModal ? "a_btn_row" : "invt_btn_row"} id={id}>
      ...
      <Button
        className={isModal ? "a_btn" : "invt_btn"}
        text={t(text1 ?? "page.cancel")}
        onClick={onClickCancel}
      />
      {!noSave && (
        <Button
          className={isModal ? "a_btn" : "invt_btn"}
          id={isModal ? "a_btn_save" : "invt_btn_save"}
          text={t(text2 ?? "page.save")}
          type={type}
          onClick={onClickSave}
        />
